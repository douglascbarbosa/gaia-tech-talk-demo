...
<template>
    ...
    >
        ...
        >
            ...
            >
                <div
                    class="flex min-h-0 flex-1 flex-col overflow-hidden rounded-br-lg rounded-bl-lg bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:self-stretch lg:rounded-tl-lg lg:rounded-br-none dark:bg-[#161615] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                    <img
                        src="/gaia-tech-talk.png"
                        alt="GAIA Tech Talk"
                        class="block aspect-[16/10] w-full object-cover object-center lg:aspect-auto lg:h-full lg:min-h-0"
                    />
                </div>
                <div
